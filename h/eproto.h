...
#endif
extern BUFFER *find_buffer(char *bname, int cflag, int bflag);
extern BUFFER *buffer_name_autocomplete(char *prompt, char *defval, int createflag);
...
extern char *command_key_sequence_to_string(int c, char *seq);
...
extern char *prompt_filename(char *prompt);
...
extern int execkey(KEY_BINDING *key, int f, int n);
...
extern int set_key(KEY_BINDING *key, char *name);
extern int xunlock(char *fname);
extern KEY_BINDING *getbind(int c);
...
extern int a_propos(int f, int n);
extern int back_char(int f, int n);
extern int backdel(int f, int n);
extern int backward_line(int f, int n);
extern int backward_page(register int f, register int n);
extern int backword(int f, int n);
extern int bclear(BUFFER *bp);
extern int binary(char *key, char *(*tval)(), int tlength, int klength);
extern int bind_to_key(int f, int n);
extern int build_list_of_bindings(int type, char *mstring);
...
extern int describe_bindings(int f, int n);
extern int describe_key(int f, int n);
...
extern int file_append(int f, int n);
extern int find_screen(int f, int n);
extern int find_file(int f, int n);
extern int filename(int f, int n);
extern int file_read(int f, int n);
extern int filesave(int f, int n);
extern int file_write(int f, int n);
...
extern int forward_char(int f, int n);
extern int forwdel(int f, int n);
extern int forward_line(int f, int n);
extern int forward_page(int f, int n);
...
extern int goto_begining_of_buffer(int f, int n);
extern int goto_begining_of_line(int f, int n);
extern int goto_begining__of_paragraph(int f, int n);
extern int goto_end_of_buffer(int f, int n);
extern int goto_end_of_line(int f, int n);
extern int goto_end_of_paragraph(int f, int n);
extern int goto_line(int f, int n);
extern int goto_mark(int f, int n);
...
extern int insert_file(int f, int n);
...
extern int bind_macro_to_key(int f, int n);
...
extern int remove_mark(int f, int n);
...
extern int set_mark(int f, int n);
...
extern int execute_startup_file(char *sfname);
extern int storeproc(int f, int n);
extern int string_contains(char *source, char *sub);
extern int swap_mark(int f, int n);
...
extern int unbind_char(int c);
extern int unbind_key(int f, int n);
...
extern int view_file(int f, int n);
...
extern unsigned int get_command_key_sequence(int mflag);
...
extern void command_autocomplete(char *name, int *cpos);
...
extern void make_buffer_name_unique(char *name);
